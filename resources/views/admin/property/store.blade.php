            ...
            <div class="card-box">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <h4 class="mt-0 mb-3 header-title">Add Property</h4>

                    </div>

                </div>

                <form class="mt-3" action="{{ url('admin/property/add') }}" id="form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="main_title" required>
...
<div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control ckeditor" id="features" rows="6" name="features" ></textarea>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                {{ Form::select('amenity_id[]',$amenitiess,null,['class'=>'form-control basic-multiple','multiple','required']) }}
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control ckeditor" rows="6" name="amenity_description"></textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <!-- <input class="form-control" type="number" min="0"   name="bedrooms" required> -->
                                {{ Form::select('bedrooms[]',$bedrooms,null,['class'=>'form-control basic-multiple','multiple','required']) }}
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" min="0"   name="bathrooms">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" min="0"   name="parking_space">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                {{ Form::select('accommodataion_id[]',$accommodataion,null,['class'=>'form-control basic-multiple','multiple','required']) }}                         
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                {{ Form::select('neighbourhoods_id[]',$neighbourhoods,null,['class'=>'form-control basic-multiple','multiple','required']) }}
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                {{ Form::select('specifications_id[]',$specification,null,['class'=>'form-control basic-multiple','multiple']) }}
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                {{ Form::select('communities_id',$communities,null,['class'=>'form-control','required']) }}
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                {{ Form::select('rating',[1=>'Active',2=>'Inactive'],null,['class'=>'form-control','required']) }}
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                {{ Form::select('property_type',[1=>'Featured',2=>'All-properties',5=>'Other'],null,['class'=>'form-control','required']) }}
                         ...
                         <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <label for="email"> Developer </label>
                                 ...
                                 {{ Form::select('developer',$developer,null,['class'=>'form-control']) }}
