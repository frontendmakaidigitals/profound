   ...
   <div class="row">
      <div class="col-12">
         <div class="card-box">
            <div class="row">
               <div class="col-md-9">
                  <h4 class="mt-0 mb-3 header-title">Category</h4>
               </div>
                           ...
                           <td>
                              <div class="dropdown float-right">
                                 ...
                                 <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item delete" data-id=" {{ $rows->id}}" href="{{ url('admin/category/delete/'.$rows->id) }}" onclick="return confirm('Are you sure you want to delete this data ?')">
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form  action="{{ url('admin/category/add') }}" method="post" id="form" >
