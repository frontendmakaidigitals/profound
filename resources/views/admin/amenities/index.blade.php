   ...
   <div class="row">
      <div class="col-12">
         <div class="card-box">
            <div class="row">
               <div class="col-md-9">
                  <h4 class="mt-0 mb-3 header-title">Amenities</h4>
               </div>
            ...
            <div class="row">
               <div class="col-md-12">
                  <table id="example" class="table table-hover">
                     ...
                     <tbody>
                        <?php $i =1; ?>
                        @foreach($amenities as $rows)
                        <tr>
                           <th scope="row">{{ $i++ }}</th>
                           <td>
                              <div class="">
                                 <img src="{{ asset($rows->icon) }}" alt="icon" width="50px" height="50px">
                              </div>
                           </td>
                           <td>{{$rows->name}}</td>
                           <td>
                           ...
                           <td>
                              <div class="dropdown float-right">
                                 ...
                                 <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item delete" data-id=" {{ $rows->id}}" href="{{ url('admin/amenities/delete/'.$rows->id) }}" onclick="return confirm('Are you sure you want to delete this data ?')">
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form  action="{{ url('admin/amenities/add') }}" method="post" id="form" >
...
<script type="text/javascript">
   $(document).on('click','.open_modal',function(){
          var url = "amenities/edit";
          var id= $(this).attr('data-id') ;
          $.get(url + '/' + id, function (data) {
              //success data
              console.log(data);
              var  img = window.location.origin+'/' +data.data.icon;
