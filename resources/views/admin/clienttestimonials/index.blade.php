...
@section('pageTitle', 'Admin | Client Testimonials') 
@section('content')
   ...
   <div class="row">
      <div class="col-12">
         <div class="card-box">
            <div class="row">
               <div class="col-md-9">
                  <h4 class="mt-0 mb-3 header-title">Client Testimonials</h4>
               </div>
            ...
            <div class="row">
               <div class="col-md-12">
                  <table id="example" class="table table-hover">
                     ...
                     <tbody>
                        <?php $i =1; ?>
                        @foreach($clientfeedback as $rows)
                        <tr>
                           <th scope="row">{{ $i++ }}</th>
                           <td>
                              <div class="">
                           ...
                           <td>
                              <div class="dropdown float-right">
                                 ...
                                 <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item delete" data-id=" {{ $rows->id}}" href="{{ url('admin/clienttestimonials/delete/'.$rows->id) }}" onclick="return confirm('Are you sure you want to delete this data ?')">
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form  action="{{ url('admin/clienttestimonials/add') }}" method="post" id="form" >
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  <label for="name">Designation/Location:</label>
...
<script type="text/javascript">
   $(document).on('click','.open_modal',function(){
          var url = "clienttestimonials/edit";
