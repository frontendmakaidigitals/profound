...
@if($pagemeta)
 ...
 @else
	 @section('title', 'Ready Properties')
...
?>
<div class="main-content px-5 pb-0">
 <div class="flat-title page-property-grid-2">
            ...
            <div class="col-12">
            <div class="content">
            <h2 class="wow fadeInUp">Ready</h2>
            <ul class="breadcrumbs wow fadeInUp">
            <li><a href="index.html">Home</a></li><li>/</li><li>Ready</li>
            </ul>
            ...
            <span class="inner">All Properties</span>
            </li>
            @foreach($properties as $row)
            @if($row->properties->count() > 0)
            <li class="item-title">
            <span class="inner">{{$row->name}}</span>
            </li>
            @endif
            @endforeach
            @endif
                ...
                <div class="widget-content-inner active">
                    ...
                    <div class="row">
                        ...
                        @foreach($properties as $property)
                            @foreach($property->properties as $row) 
                                <?php                                                                               
                                    //dd($row);
                                    if($row->price == '0'){
                                        $price = 'Ask for Price';
                            ...
                            <div class="col-xl-4 col-md-6">
                                ...
                                <div class="image">
                                <div class="list-tags">
                                <a href="{{ url('off-plans-property/'.$row->slug) }}" class="tags-item for-sell">Ready</a>
                                ...
                                <div class="head">
                                <div class="title">
                                <a href="{{ url('off-plans-property/'.$row->slug) }}">{{substr_replace($row->title, "...", 25)}}</a>
                                </div>
                                ...
                                <p><?php
                                                                            ...
                                                                            echo substr_replace($row->address, "...", 45);
                ...
                <div class="widget-content-inner">
                    ...
                    <div class="row">
                            ...
                            <div class="col-xl-4 col-md-6">
                                ...
                                <div class="image">
                                <div class="list-tags">
                                <a href="{{ url('off-plans-property/'.$property->slug) }}" class="tags-item for-sell">Ready</a>
                                <!--<a href="{{ url('off-plans-property/'.$row->slug) }}" class="tags-item featured">FEATURED</a>-->
                                </div>
                                ...
                                <div class="swiper-slide">
                                <div class="">
                                <img class="" src="{{ asset($property->image) }}" alt="">
                                </div>
                                </div>
                                @endif
                                ...
                                <div class="head">
                                <div class="title">
                                <a href="{{ url('off-plans-property/'.$property->slug) }}">{{substr_replace($property->title, "...", 25)}}</a>
                                </div>
                                <div class="price">@if($property->price == '0') {{ $price }} @else AED {{ $price }} @endif</div>
                                </div>
                                <div class="location">
                                <div class="icon">
                                <i class="flaticon-location"></i>
                                ...
                                <p>
                                <?php                                        
                                echo substr_replace($property->address, "...", 45);
                                ?>
                                </p>
                                ...
                                <div class="icon-box">
                                @if(count($property->propertyBedrooms) > 0)
                                <div class="item">
                                <i class="flaticon-hotel"></i>
                                <p>{{$property->propertyBedrooms->implode('bedrooms',',')}}</p>
                                </div>
                                @endif
