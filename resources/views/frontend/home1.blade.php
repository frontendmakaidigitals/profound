...
.swipeProp1 .swiper-button-prev:after, .swipeProp1 .swiper-rtl .swiper-button-next:after {
...
.swipeProp1 .swiper-button-next, .swiper-rtl .swiper-button-prev {
...
.swipeProp1 .swiper-button-prev, .swiper-rtl .swiper-button-next {
...
.swipeProp1 .swiper-button-next:after, .swiper-rtl .swiper-button-prev:after {
...
.estate-agents{
    ...
    background-image: url({{ asset('frontend/assets/images/Mask.webp') }}) !important;
...
<style>
    ...
    .flexBoxMain {
        border-radius: 70px;
        box-shadow: 0px 0px 0px 10px rgb(187 194 195 / 61%) !important;
        z-index: 999;
    }
</style>
...
?>
    ...
    <section class="mainBg main-banner">
                ...
                <div class="col-12 col-lg-12">
                    ...
                    <!--<div class="mainPropForm">-->
                        ...
                        <form id="searchForm" action="{{ url('off-plans') }}" method="GET" enctype="multipart/form-data">
                            ...
                            <div class="d-flex flex-row justify-content-center bg-white flexBoxMain align-items-center" style="height:40px">
                                    ...
                                    <div class="single-query form-group">
                                        ...
                                        <div class="intro">
                                            ...
                                            <div class="dropdown myDrop">
                                                ...
                                                <a class="d-flex justify-content-between align-items-center" onclick="BShameMenu();" role="button" data-toggle="dropdown" data-target="#">
                                                                    ...
                                                                    @if ($stats == 'Buy')
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <div class="">
                                                                                ...
                                                                                <button type="button" class="btn btn-outline-primary btnSelBuy mb-2 @if ($stats == 'Off-Plan') active @endif" btnId="{{ $stats }}" btnById="{{ $status->id }}">{{ $stats }}</button>
                                ...
                                <div class="p-2 flex-fill bd-highlight border-end d-flex">
                                    ...
                                    <select name="title[]" id="bedroom" placeholder="Select Property Name" class="form-select formSel selectpicker" multiple aria-label="Default select example" data-live-search="true"> 
                                        <?php $titles = getpropertyName() ;?>
                            ...
                            <div class="advncSearch" style="display:none;">
                                ...
                                <div class="advSearClose mt-2" style="display: none;"><a><i class="bi bi-x-square"></i></a>

                                </div>

                                <div class="d-flex flex-row justify-content-center bg-white mt-3 flexBoxMain" style="height:40px !important">
                                    ...
                                    <div class="p-2 flex-fill bd-highlight border-end d-flex ">
                                        ...
                                        <input type="text" name="min_area" id="area" class="form-control" placeholder="Min area sqft" style="height:10px">

                                    </div>

                                    <div class="p-2 flex-fill bd-highlight border-end d-flex ">

                                        <input type="text" name="max_area" id="area" class="form-control" placeholder="Max area sqft" style="height:10px">
                                ...
                                <div class="communitiesDiv mt-3">
                                    ...
                                    @foreach($communities as $row)
                                        <div class="comRdBtn">
                                            ...
                                            <label for='community_{{$row->id}}'>{{ $row->name }}({{$row->community_property_count}})</label>
        ...
        <div class="videosec">
            ...
            <div class="video-wrapper d-none d-md-block">
                ...
                <video autoplay="" loop="" muted="" playsinline="" preload="metadata" src="{{ asset('frontend/assets/videos/Header-Video_live.mp4') }}">

                    <source src="{{ asset('frontend/assets/videos/Header-Video_live.mp4') }}" type="video/mp4">
                </video>
            ...
            <div class="video-wrapper d-block d-md-none">
                ...
                <video autoplay="" loop="" muted="" playsinline="" preload="metadata" src="{{ asset('frontend/assets/videos/home_video_mobile_live.mov') }}">
                        ...
                        <source src="{{ asset('frontend/assets/videos/home_video_mobile_live.mov') }}" type="video/mp4">
    ...
    <section class="bgMainAll" id="scrollto">
        ...
        <div class="container-fluid">
                                    ...
                                    <div class="single-query form-group">
                                        ...
                                        <div class="intro">
                                            ...
                                            <div class="dropdown myDrop">
                                                ...
                                                <a onclick="BShameMenu();" role="button" data-toggle="dropdown" data-target="#">
            ...
            <?php /* ?><div class="row py-5 justify-content-center">
                ...
                <div class="col-12 col-lg-12">
                    ...
                    <div class="row py-5 justify-content-center d-lg-block d-md-block d-sm-none d-none">
                        ...
                        <div class="col-12 col-lg-12">
                            ...
                            <div class="text-center">
                                ...
                                <div class="mainHeadingCent  py-2">Latest <span
                        ...
                        <div class="gallery col-lg-12 col-md-12 col-sm-12 col-xs-12" style="z-index: 999;">
                            ...
                            <nav align="center">
                                ...
                                <div class="nav nav-tabs border-0 justify-content-center" id="nav-tab" role="tablist">
                                    ...
                                    <button class="filter-button myBtn nav-link active" id="nav-home-tab"
                                ...
                                @foreach($accommodataion as $row)
                                    ...
                                    <button class="filter-button myBtn nav-link" id="nav-profile-tab"

                                        data-bs-toggle="tab" data-bs-target="#{{$row->name}}" type="button" role="tab"

                                        aria-controls="nav-profile" aria-selected="false">{{$row->name}}</button>

                                 @endforeach

                                    <button class="filter-button myBtn nav-link" id="nav-contact-tab"><a href="{{url('off-plans') }}"

                                            class="text-white text-decoration-none"> VIEW MORE</a></button>
                    ...
                    <div class="tab-content clearfix">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="card-body py-2">
                                                        ...
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <p class="card-text priceText mb-0">@if($row->price == '0') {{ $price }} @else AED {{ $price }} @endif
                        ...
                        <div class="tab-pane" tabId="all" id="{{$row->name}}">
                                            ...
                                            <div class="row g-0">
                                                ...
                                                <div class="col-md-12 my-auto">
                                                    ...
                                                    <center>
                                                        ...
                                                        <a href="{{ url('off-plans-property/'.$property->slug) }}">
                                                    ...
                                                    <button class="btn btn-pill btnType mb-0"
                                                        ...
                                                        style="font-size:11px;">FOR OFF PLAN</button>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="card-body py-2">
                                                        ...
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <p class="card-text priceText mb-0">AED {{$property->price}}

                                                            </p>

                                                            <div class="d-flex justify-content-center propDet my-auto">

                                                                @if($property->bedrooms != 0)<p><i class="fa fa-bed"></i> {{$property->bedrooms}}</p>@endif

                                                                @if($property->bathrooms != 0)<p><i class="fa fa-shower"></i> {{$property->bathrooms}}</p>@endif

                                                                @if($property->area != 0)<p><i class="fa fa-map-o"></i> {{$property->area}}sqft</p>@endif
                                                        ...
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <div class="text-start">
                                                                ...
                                                                <p class="card-text propNameText mb-0"><a class="text-decoration-none " href="{{ url('off-plans-property/'.$property->slug) }}">{{$property->title}}</a>
            ...
            <div class="col-12 col-lg-12">
                ...
                <div class="tab-content clearfix">
                    ...
                    <div class="tab-pane active " tabId="all" id="all_one">
                        <div class="swiper swipeProp1 py-5">
                            <div class="swiper-wrapper"> @if(count($featureProperties) > 0) 
                                @foreach($featureProperties as $row)
                                @if($row->is_crm == 0)
                                <?php
                                            ...
                                            <div class="row g-0">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="card-body py-2">
                                                        <div class="d-flex justify-content-between">
                                                            <div class="text-start">
                                                                <p class="card-text propNameText mb-0"> <a class="text-decoration-none " href="{{ url('off-plans-property/'.$row->slug) }}"><b>{{$row->title}}</b></a> </p> <small class="text-primary">
                                                        ...
                                                        <div class="d-flex justify-content-between">
                                                            <div class="d-flex justify-content-center propDet my-auto"> @if($row->propertyBedrooms->count() > 0)
                                                                ...
                                                                <p><i class="fa fa-shower"></i> {{$row->bathrooms}}</p>@endif 
                                                                @if($row->area != 0)
                                                                <p><i class="fa fa-map-o"></i> {{$row->area}}sqft</p>@endif 
                                                            </div>
                                                        </div>
                                                        <div class="d-flex justify-content-between">
                                                            <div class="text-start">
                                                                <p class="card-text propNameText mb-0"> <a class="text-decoration-none " href="{{ url('off-plans-property/'.$row->slug) }}">
                                                                    <b>@if($row->price == '0') {{ $price }} @else AED {{ $price }} @endif </a></b> </p> <small class="text-primary">
                                                            </small> </div>
                                                            <div class="d-flex justify-content-center propShare my-auto">
                                                                <p><i class="bi bi-share-fill"></i></p>
                                                            </div>
        ...
        <!--feature listing end-->
        <!--all properies start-->
        <div class="row py-5 justify-content-center" style="padding-top:0 !important">
            <div class="col-12 col-lg-12">
                <div class="row py-5 justify-content-center d-lg-block d-md-block d-sm-none d-none">
                    <div class="col-12 col-lg-12">
                        <div class="text-center">
                            <div class="mainHeadingCent  py-2">All <span class="secText text-primary">Properties</span> </div>
                        </div>
                    </div>
                </div>
                <div class="row py-0 justify-content-center d-lg-none d-md-none d-sm-block">
                ...
                <div class="row g-3 latest-options">
                    <div class="gallery col-lg-12 col-md-12 col-sm-12 col-xs-12" style="z-index: 999;">
                        <nav align="center">
                            <div class="nav nav-tabs border-0 justify-content-center" id="nav-tab" role="tablist">
                                <button class="filter-button myBtn nav-link" id="nav-contact-tab"><a href="{{url('all-properties') }}" class="text-white text-decoration-none"> VIEW MORE</a></button>
                            </div>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row g-3">
                    <div class="swiper swipeProp1 py-5">
                        <div class="swiper-wrapper">
                            @if(count($featureProperties) > 0)
                                @foreach($featureProperties as $row)
                                <?php //$count = $property->properties->count();?>
                                <?php
                                   //dd($row);
                                    if($row->price == '0'){
                                        $price = 'Ask for Price';
                                    ...
                                    <div class="card mb-3 bg-white rounded-0 border-0">
                                        <div class="row g-0">
                                            <div class="col-md-12 my-auto">
                                                ...
                                                <button class="btn btn-pill btnType mb-0"
                                                    style="font-size:11px;">{{$row->status==2?"Off-Plan":"Completed"}}</button>
                                            </div>
                                            <div class="col-md-12">
                                                    <div class="card-body py-2">
                                                        <div class="d-flex justify-content-between">
                    ...
                    <div class="col-12 col-lg-12 justify-content-center g-4 mb-5" style="text-align: center;height: 300px;padding-top: 20px;margin: 20px;background-color: #06112c;">
                         ...
                         <p> Try resetting the filters </p><p>
                         <a href="{{ url('ready') }}" class="btn btn-color btn-secondary" style="margin-top: 15px;"> Reset Filters </a>
                        </p>
                    </div>
                    @endif
                </div>
                <!-- <div class="col-12 col-lg-12 text-center mt-3">
                    <a name="submit" type="button" class="btn btn-secondary btn-mb mr-2 btnEnquire">View More</a>
                </div> -->
            </div>
        </div><?php */ ?>
            ...
            <div class="row py-5">
                ...
                <div class="col-12 col-lg-12 my-auto">
                    ...
                    <div class="d-flex justify-content-between my-auto">
                        ...
                        <div class="mainHeadingCent  py-2">Our <span class="secTextShort text-primary">Team</span>
                ...
                <div class="col-12 col-lg-12">
                    ...
                    <div class="swiper swipeTeam pb-2" style="background: #DEC093;">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide teamSwipe">

                                <img src="{{ $agent->image }} " class="img-fluid"
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6 my-auto">
                            ...
                            <div>
                                ...
                                <div class="mainHeadingCent pb-2">We are the Best and Most

                                    Trusted <span class="secText text-primary">Real Estate Agents</span></div>
                                ...
                                <div class="mainDesc py-2">
                                    ...
                                    <div class="d-flex justify-content-start py-4 pe-3">
                                        ...
                                        <div class="my-auto1" >
                                            ...
                                            <img src="{{ asset('frontend/assets/images/buy.png') }}" alt="" class="img-fluid pe-3 w-100">
                                        ...
                                        <div class="my-auto text-white">
                                            ...
                                            <h5>Browse from millions of best properties in your city, save your favorites, and set up search alerts.</h5>
                                    ...
                                    <div class="d-flex justify-content-start py-4 pe-3">
                                        ...
                                        <div class="my-auto1">
                                            ...
                                            <img src="{{ asset('frontend/assets/images/rent.png') }}" alt="" class="img-fluid pe-3 w-100">
                                        ...
                                        <div class="my-auto text-white">
                                            ...
                                            <h5>Communicate directly with the advertiser and get verified leads with us.</h5>
                                    ...
                                    <div class="d-flex justify-content-start py-4 pe-3">
                                        ...
                                        <div class="my-auto1">
                                            ...
                                            <img src="{{ asset('frontend/assets/images/sell.png') }}" alt="" class="img-fluid pe-3 w-100">
                                        ...
                                        <div class="my-auto text-white">
                                            ...
                                            <h5>Are you looking to sell your home? In just a few steps, you can find the best buyer for your property.</h5>
                                    ...
                                    <div class="d-flex justify-content-start py-4">
                                        ...
                                        <div class="col-12"><button class="btn btn-secondary" id="getCalendarModalhome">BOOK YOUR SLOT
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-12 my-auto text-center">
                    ...
                    <div>
                        ...
                        <!--<h5 class="text-white">10-year renewable residency granted to exceptional talent & investors</h5>-->
                    ...
                    <div class="row">
                                ...
                                <div class="col-lg-10 col-4">
                                    ...
                                    <div class="text-center py-3">
                                        ...
                                        <div class="">
                                            ...
                                            <center><img src="{{ asset('frontend/assets/images/group1.png') }}"

                                                    alt="" class="img-fluid" width="100px"></center>
                                        ...
                                        <div class="my-auto text-white">
                                            ...
                                            <h5>Get access to a 10-year renewable residency</h5>
                                ...
                                <div class="col-lg-10 col-4">
                                    ...
                                    <div class="text-center py-3">
                                        ...
                                        <div class="my-auto text-white">
                                            ...
                                            <!--<h5>No restriction on the maximum duration of stay outside the UAE is removed</h5>-->

                                            <h5>No limit on maximum stay duration outside UAE</h5>
                        ...
                        <div class="col-12 col-lg-4 my-auto">
                            ...
                            <div class="">
                                ...
                                <center><img src="{{ asset('frontend/assets/images/golden.png') }}" alt="" class="img-fluid middle-image"> 
                                ...
                                <div class="col-lg-10 col-4">
                                    ...
                                    <div class="text-center py-3">
                                        ...
                                        <div class="my-auto text-white">
                                            ...
                                            <!--<h5>No sponsor or employer required</h5>-->

                                            <h5>No sponsor or employer is required to apply.</h5>
                                ...
                                <div class="col-lg-10 col-4">
                                    ...
                                    <div class="text-center py-3">
                                        ...
                                        <div class="my-auto text-white">
                                            ...
                                            <!--<h5>New six-month visa launched to help applicants finalize Golden Visa</h5>-->

                                            <h5>Entry visa valid for 6 months with multiple entries</h5>
        ...
        <div class="container py-5">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-12">
                    ...
                    <!--<div class="swiper swipeDeveloper pb-2" style="background: #fff;">-->
                    ...
                    <!--            <center><img src="{{ $developer->dev_logo }}"-->

                    <!--                alt="{{ $developer->title }}" width="120" class="img-fluid">-->
                    ...
                    ?>
                        ...
                        @foreach($developers as $developer)
                            ...
                            <div class="">
                              ...
                              <a href="{{ asset($developer->dev_logo) }}">

                              <img src="{{ asset($developer->dev_logo) }}"> 
        ...
        <div class="container py-5">
            ...
            <div class="row mt-4">
                ...
                <div class="col-lg-12 col-12">
                    ...
                    <div class="devlopers pb-2" style="background: #fff;">
