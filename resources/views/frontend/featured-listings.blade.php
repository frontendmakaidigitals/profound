...
?>
    ...
    <section class="mainBg"  style="background:url('{{($banner != null) ? asset($banner->image) :  asset('frontend/assets/images/property/img_1647490856.jpg')}}')">
 ...
 <div class="d-flex justify-content-between">
                        ...
                        <div class="resetBtn mt-4 text-white"><a href="{{url('featured-listings')}}" class="text-white">Reset</a></div>
                    </div>
                    ...
                    <div class="row py-5 justify-content-center d-lg-block d-md-block d-sm-none d-none">
                        ...
                        <div class="col-12 col-lg-12">
                            ...
                            <div class="text-center">
                                ...
                                <div class="mainHeadingCent  py-2">Featured <span
                                ...
                                <div class="row g-0">
                                    <div class="col-md-12 my-auto">
                                        <center>
                                            ...
                                            @if($row->image) 
                                            <img src="{{ asset($row->image) }}" alt="image" loading="lazy" class="card-img-top propImage rounded-0"> 
                                            @endif
                                            </a>
                                        </center>
                                        <button class="btn btn-pill btnType mb-0" style="font-size:11px;">
                                            <font style="vertical-align: inherit;">
                                                <font style="vertical-align: inherit;">{{$row->status==2?"Off-Plan":"Ready"}}
                                                </font>
                                            </font>
                                        </button>
                                    </div>
                            ...
                            <div class="gallery col-lg-12 col-md-12 col-sm-12 col-xs-12" style="z-index: 999;">
                                <nav align="center">
                                    <div class="nav nav-tabs border-0 justify-content-center" id="nav-tab" role="tablist">
                                        <button class="filter-button myBtn nav-link" id="nav-contact-tab"><a href="{{url('all-properties') }}" class="text-white text-decoration-none"> ALL PROPERTIES</a></button>
                                    </div>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="col-12 col-lg-12 borderBotFoot">
                    <div class="row py-5 justify-content-center">
                        <div class="col-12 col-lg-12 justify-content-center g-4 mb-5" style="text-align: center;height: 300px;padding-top: 20px;margin: 20px;background-color: #06112c;">
                             ...
                             <a href="{{ url('featured-listings') }}" class="btn btn-color btn-secondary" style="margin-top: 15px;"> Reset Filters </a>
                            </p>
                        </div>
                    </div>
                </div>
