...
<div class="main-content px-5 pb-0">
            ...
            <div class="content">
            <h2 class="wow fadeInUp">Rent</h2>
            <ul class="breadcrumbs wow fadeInUp">
            <li><a href="index.html">Home</a></li><li>/</li><li>Rent</li>
            </ul>
                    ...
                    <div class="row">
                        ...
                        @foreach($properties as $property)
                            ...
                            <div class="col-xl-4 col-md-6">
                                ...
                                <div class="image">
                                <div class="list-tags">
                                <a href="{{ url('off-plans-property/'.$row->slug) }}" class="tags-item for-sell">Rent</a>
                ...
                <div class="widget-content-inner">
                    ...
                    <div class="row">
                            ...
                            <div class="col-xl-4 col-md-6">
                                ...
                                <div class="image">
                                <div class="list-tags">
                                <a href="{{ url('off-plans-property/'.$property->slug) }}" class="tags-item for-sell">Rent</a>
                                <!--<a href="{{ url('off-plans-property/'.$row->slug) }}" class="tags-item featured">FEATURED</a>-->
                                </div>
