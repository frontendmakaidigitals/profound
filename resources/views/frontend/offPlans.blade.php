...
@if($pagemeta)
 ...
 @else
	 @section('title', 'Off-plan Properties')
...
?>
  ...
  <!-- main-content -->
            ...
            <div class="content">
            <h2 class="wow fadeInUp">Off-Plan</h2>
            <ul class="breadcrumbs wow fadeInUp">
            <li><a href="index.html">Home</a></li><li>/</li><li>Off-Plan</li>
            </ul>
        ...
        <!--    </div>-->
            ...
            <div class="widget-content-tab">
                ...
                @foreach($properties as $row )
                    @if($row->properties->count() > 0)
                    <div class="widget-content-inner {{ $isFirst ? 'active' : '' }}">
                        <?php 
                        $count = 0;
                        $brk_val=100;
                        $isFirst = false; // Mark that the first valid iteration is done
                        ?>
                        <div class="row">
                            @php
                            $sortedProperties = $row->properties->sortByDesc('created_at');
                            @endphp
                                @foreach($sortedProperties as $property) 
                                    ...
                                    <div class="col-xl-4 col-md-6">
                                        ...
                                        <div class="image">
                                        <div class="list-tags">
                                        <a href="{{ url('off-plans-property/'.$property->slug) }}" class="tags-item for-sell">Off-Plan</a>
                                        ...
                                        <div class="head">
                                        <div class="title">
                                        <a href="{{ url('off-plans-property/'.$property->slug) }}">{{ \Illuminate\Support\Str::limit($property->title, 35) }}
</a>
                                        </div>
                                        <style>
                                            .start-price{font-size: 14px !important;color: #000 !important;font-weight: 300 !important;margin-bottom:5px;}
                                        </style>
                                        <div class="price">@if($property->price == '0') {{ $price }} @else <p class="start-price">Starting Price:</p> AED {{ $price }} @endif</div>
                                        </div>
                                        <div class="location">
                                        <div class="icon">
