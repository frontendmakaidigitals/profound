...
<div class="main-content px-20 default">
                ...
                <section class="flat-title inner-page" style="background:url({{ ($banner != null) ? asset($banner->image) : '/frontend/assets/images/list-your-property.jpg' }});background-repeat:no-repeat;background-size:cover;">
                    <div class="cl-container full">
                        <div class="row">
                            <div class="col-12">
                                <div class="content">
                                    <h2>{{ ($banner != null) ? $banner->heading_one :  'LIST YOUR PROPERTY AT THE BEST PRICES'}}</h2>
                ...
                <p class="text-center">Property listing has never been easier, with Profound Realtors, sell or rent your properties at compelling prices. Profound Realtors, a leading real estate brokerage firm in Dubai is accredited for its stellar performance and expansive knowledge of the market. List your property with Profound Realtors and sit back tension-free knowing your investment is in safe hands. Reach us today and get a free valuation.</p>
                <div class="row justify-content-center mt-5">
                <div class="col-md-8">
                <h3 class="text-center">List your property here.</h3>
                <p class="text-center">If you list now, your property valuation is on us.</p>
